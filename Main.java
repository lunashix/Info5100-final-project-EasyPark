...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // public static void removeVehicleAndPrintBill (Scanner scanner, ParkingLot
        // parkingLot){

        // System.out.print("Enter the vehicle plate number to remove: ");
        // String plateNumber = scanner.next();

        // ArrayList<ParkingSpot> foundParkingSpots =
        // parkingLot.findVehicleByPlateNumber(plateNumber);

        // if (!foundParkingSpots.isEmpty()) {
        // System.out.println("Found the vehicle with plate number " + plateNumber + "
        // in the following spots:");
        // for (ParkingSpot spot : foundParkingSpots) {
        // System.out.println(spot.getSpotId());
        // }
        // System.out.print("Enter the spot ID from which you want to remove the
        // vehicle: ");
        // String spotId = scanner.next();
        ...
        // }
        // } else {
        // System.out.println("Vehicle with plate number " + plateNumber + " is not
        // parked in any spot.");
        // }
